...
BRANCHES = ["tandarts", "advocaat", "huisarts"]
LOCATIES = {
...
def email_from_google_snippet(bedrijfsnaam, stad):
    ...
    try:
        for result in search(query, num_results=5):
            ...
            if emails:
                print(f"Gevonden email via Google: {emails[0]}")
                return emails[0]
...
def main():
    ...
    df.to_csv("bedrijven_gevonden.csv", index=False, encoding="utf-8-sig")
    print("📁 CSV opgeslagen als 'bedrijven_gevonden.csv'")
